...
public class NetOutPatientCostDetailUploadDto {
    ...
    @ApiModelProperty(value = "收费批次号", hidden = true)
    private String chrgBchno;

    @ApiModelProperty(value = "处方号", hidden = true)
    private String rxno;
    ...
    @ApiModelProperty(value = "单次剂量描述", hidden = true)
    private String sinDosDscr;

    @ApiModelProperty(value = "使用频次描述", hidden = true)
    private String usedFrquDscr;

    @ApiModelProperty(value = "用药周期天数", hidden = true)
    private String prdDays;

    @ApiModelProperty(value = "用药途径描述", hidden = true)
    private String medcWayDscr;

    @ApiModelProperty(value = "医疗目录编码", hidden = true)
    ...
    @ApiModelProperty(value = "受单科室编码", hidden = true)
    private String acordDeptCodg;

    @ApiModelProperty(value = "受单科室名称", hidden = true)
    private String acordDeptName;

    @ApiModelProperty(value = "受单医生编码", hidden = true)
    private String ordersDrCode;

    @ApiModelProperty(value = "受单医生姓名", hidden = true)
    ...
    @ApiModelProperty(value = "外检医院编码", hidden = true)
    ...
    @ApiModelProperty(value = "不进行审核说明", hidden = true)
    private String unchkMemo;

    @ApiModelProperty(value = "医疗机构目录名称", hidden = true)
