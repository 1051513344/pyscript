...
def getusermanagerdept():
    ...
    data = {"1":'{"command":"actionplanbase/getusermanagerdept","sessionid":"[sessionid]","loginid":"1","uid":"1","paramcode":"actionplanaddroles"}'.replace("[sessionid]", sessionid)}
...
def getspeaker_Hospital():
    ...
    data = {"1":'{"command":"actionplanbase/getspeaker","sessionid":"[sessionid]","loginid":"1","speakername":"","actionplanlevel":"hospital","deptid":99}'.replace("[sessionid]", sessionid)}
...
def getspeaker_Base():
    ...
    data = {"1":'{"command":"actionplanbase/getspeaker","sessionid":"[sessionid]","loginid":"1","speakername":"","actionplanlevel":"base","deptid":[baseid]}'.replace("[sessionid]", sessionid).replace("[baseid]", baseid)}
...
def getspeaker_Office(deptlist):
    ...
    data = {"1":'{"command":"actionplanbase/getspeaker","sessionid":"[sessionid]","loginid":"1","speakername":"","actionplanlevel":"office","deptid":[deptid]}'.replace("[sessionid]", sessionid).replace("[deptid]", deptid)}
...
def turnbaseinfolevel():
    ...
    data = {"1":'{"command":"turnbaseinfo/turnbaseinfolevel","sessionid":"[sessionid]","loginid":"1","code":"teachtype"}'.replace("[sessionid]", sessionid)}
...
def queryDictionaryList1():
    ...
    data = {"1":'{"command":"traineestudent/queryDictionaryList","sessionid":"[sessionid]","loginid":"1","uid":"1","code":"turngrade"}'.replace("[sessionid]", sessionid)}
...
def queryDictionaryList2():
    ...
    data = {"1":'{"command":"traineestudent/queryDictionaryList","sessionid":"[sessionid]","loginid":"1","uid":"1","code":"stud_type"}'.replace("[sessionid]", sessionid)}
...
def getdeptlist():
    ...
    data = {"1":'{"command":"deptinfo/getdeptlist","sessionid":"[sessionid]","loginid":"1","uid":"1","deptcode":"base"}'.replace("[sessionid]", sessionid)}
...
def getattender1():
    ...
    data = {"1":'{"command":"actionplanbase/getattender","sessionid":"[sessionid]","loginid":"1","actionplanlevel":"base","actiontime":"","deptid":100,"baseattend":"turn"}'.replace("[sessionid]", sessionid)}
...
def getattender2():
    ...
    data = {"1":'{"command":"actionplanbase/getattender","sessionid":"[sessionid]","loginid":"1","actionplanlevel":"base","actiontime":"","deptid":100,"baseattend":"base"}'.replace("[sessionid]", sessionid)}
...
def getattenderforsearch():
    ...
    data = {"1":'{"command":"actionplanbase/getattenderforsearch","sessionid":"[sessionid]","loginid":"1","actionplanlevel":"office","attendername":"[xingshi]"}'.replace("[sessionid]", sessionid).replace("[xingshi]", xingshi)}
...
def addactionplan_Base_Single_Thread(i, typelist):
    ...
    while index <= 20758:
        try:
            ...
            for i in range(10):#利用循环创建5个线程
                t=Thread(target=addactionplan_Base_Single_Thread, args=(index+i,typelist,))
                #启动线程
                threads.append(t)
